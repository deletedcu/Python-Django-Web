...
-store the random value between 5 and 9 in result.
-then we add result to the value stored in sessions['gold'] (which was 0).
...
-Then every time we hit submit button we append the result_dictionary to our session['activities'] list, session['activities'] contains a list of dictionaries.
